...
It only receives the new tree; to find out what changed (for example which
panel was removed), see [Know which panel was removed](../guides/recipes#know-which-panel-was-removed).
