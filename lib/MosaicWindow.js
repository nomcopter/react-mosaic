...
var InternalMosaicWindow = /** @class */ (function (_super) {
    ...
    function InternalMosaicWindow() {
        ...
        _this.renderDropTarget = function (position) {
            var _a = _this.props, path = _a.path, tabId = _a.tabId;
            return react_1.default.createElement(MosaicDropTarget_1.MosaicDropTarget, { position: position, path: path, key: position, tabId: tabId });
        };
